document.addEventListener('DOMContentLoaded', function() {
    ...
    idTypeInputs.forEach(input => {
        input.addEventListener('change', function() {
            ...
            idNumberLabel.textContent = isTc ? 'TC Kimlik Numarası' : 'Pasaport Numarası';
            idNumberInput.placeholder = isTc ? 'TC Kimlik numaranızı giriniz' : 'Pasaport numaranızı giriniz';
            ...
            if (isTc) {
                ...
                idNumberFeedback.textContent = 'Geçerli bir TC Kimlik numarası giriniz (11 haneli)';
            } else {
    ...
    function validateTcNumber(value) {
        ...
        let odd = 0, even = 0, total = 0, check = 0;
    ...
    document.querySelector('.btn-success[type="button"]').addEventListener('click', function() {
    ...
    flatpickr("#birthDate", {
        locale: "tr",
        dateFormat: "Y-m-d",
        maxDate: new Date(), // Bugünden sonraki tarihleri seçilemez yap
        disableMobile: false, // Mobilde native picker yerine flatpickr kullan
        monthSelectorType: "static",
        yearSelectorType: "static",
        altInput: true,
        altFormat: "d F Y", // Görünen format: "15 Ocak 2024"
